...
-- Fardel Dabyrie
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (447902, 4479, 2, 100, 4, 20, 447902, 'Fardel Dabyrie - Flee at 20% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (447902, 47, 'Fardel Dabyrie - Flee');
...
-- Bael'dun Foreman
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (337501, 3375, 2, 100, 4, 15, 337501, 'Bael\'dun Foreman - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (337501, 47, 'Bael\'dun Foreman - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=3375;
...
-- Scarlet Lumberjack
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (188401, 1884, 2, 100, 4, 15, 188401, 'Scarlet Lumberjack - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (188401, 47, 'Scarlet Lumberjack - Flee');
...
-- Stormscale Myrmidon
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (218102, 2181, 2, 100, 4, 15, 218102, 'Stormscale Myrmidon - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (218102, 47, 'Stormscale Myrmidon - Flee');
...
-- Greymist Hunter
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (220601, 2206, 2, 100, 4, 15, 220601, 'Greymist Hunter - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (220601, 47, 'Greymist Hunter - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=2206;
...
-- Kuz
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (343601, 3436, 2, 100, 4, 15, 343601, 'Kuz - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (343601, 47, 'Kuz - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=3436;
...
-- Windfury Harpy
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (296201, 2962, 2, 100, 4, 15, 296201, 'Windfury Harpy - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (296201, 47, 'Windfury Harpy - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=2962;

-- Windfury Wind Witch
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (296301, 2963, 2, 100, 4, 15, 296301, 'Windfury Wind Witch - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (296301, 47, 'Windfury Wind Witch - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=2963;

-- Windfury Sorceress
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (296401, 2964, 2, 100, 4, 15, 296401, 'Windfury Sorceress - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (296401, 47, 'Windfury Sorceress - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=2964;

-- Windfury Matriarch
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (296501, 2965, 2, 100, 4, 15, 296501, 'Windfury Matriarch - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (296501, 47, 'Windfury Matriarch - Flee');
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=2965;
...
-- Razormane Mystic
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `event_type`, `event_chance`, `event_flags`, `event_param1`, `action1_script`, `comment`) VALUES (327104, 3271, 2, 100, 4, 15, 327104, 'Razormane Mystic - Flee at 15% HP');
INSERT INTO `creature_ai_scripts` (`id`, `command`, `comments`) VALUES (327104, 47, 'Razormane Mystic - Flee');
...
UPDATE `creature_template` SET `ai_name`='EventAI' WHERE `entry`=1432;
