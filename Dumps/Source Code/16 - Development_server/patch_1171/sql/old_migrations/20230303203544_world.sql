...
UPDATE `creature_template` SET `health_min`=1, `health_max`=1, `dmg_min`=22, `dmg_max`=31, `ai_name`='EventAI' WHERE `entry`=4196;
...
UPDATE `creature_template` SET `level_min`=20, `level_max`=21, `health_min`=48, `health_max`=52, `unit_flags`=0, `flags_extra`=131072 WHERE `entry`=5781;
