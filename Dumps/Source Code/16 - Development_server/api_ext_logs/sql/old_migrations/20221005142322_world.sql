...
UPDATE `battleground_template` SET `player_loot_id`=1 WHERE `id`=1;
...
(1, 18144, 100, 0, 1, 1, 4138), -- Human Bone Chip
(1, 18206, 100, 0, 1, 1, 4139), -- Dwarf Spine
(1, 18142, 100, 0, 1, 1, 4140), -- Severed Night Elf Head
(1, 18143, 100, 0, 1, 1, 4141), -- Tuft of Gnome Hair
(1, 18207, 100, 0, 1, 1, 4142), -- Orc Tooth
(1, 18147, 100, 0, 1, 1, 4143), -- Forsaken Heart
(1, 18145, 100, 0, 1, 1, 4144), -- Tauren Hoof
(1, 18146, 100, 0, 1, 1, 4145), -- Darkspear Troll Mojo
(1, 17423, 100, 0, 1, 1, 4146), -- Storm Crystal
(1, 17306, 100, 0, 1, 1, 4147), -- Stormpike Soldier's Blood
(1, 17326, 75, 0, 1, 1, 4149), -- Stormpike Soldier's Flesh 
(1, 17502, 75, 0, 1, 1, 4150), -- Frostwolf Soldier's Medal
(1, 17327, 75, 0, 1, 1, 4152), -- Stormpike Lieutenant's Flesh
(1, 17503, 75, 0, 1, 1, 4153), -- Frostwolf Lieutenant's Medal
(1, 17328, 75, 0, 1, 1, 4155), -- Stormpike Commander's Flesh
(1, 17504, 75, 0, 1, 1, 4156); -- Frostwolf Commander's Medal
