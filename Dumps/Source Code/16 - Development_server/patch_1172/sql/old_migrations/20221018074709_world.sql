...
-- Move permanent auras of Forsaken Infiltrator to template.
DELETE FROM `creature_ai_scripts` WHERE `id` IN (380601);
DELETE FROM `creature_ai_events` WHERE `creature_id`=3806;
UPDATE `creature_template` SET `auras`='6718 3616', `ai_name`='' WHERE `entry`=3806;
...
-- Add stealth to Ashenvale Stalker.
UPDATE `creature_template` SET `auras`='6920', `ai_name`='' WHERE `entry`=70025;
...
DELETE FROM `creature_addon` WHERE `guid` IN (SELECT `guid` FROM `creature` WHERE `id` IN (3821, 3807, 3806, 3804, 70025, 12856, 2926));
