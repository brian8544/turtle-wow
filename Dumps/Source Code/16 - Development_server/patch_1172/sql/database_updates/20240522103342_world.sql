...
update spell_template SET description = 'Your auto-attacks have a 20% chance to strike an additional nearby opponent. This effect is disabled while shapeshifted and can only trigger once every 5 sec.' WHERE entry = 51068; -- Hunter's Sweep
