...
class model
{
    ...
    public $gameDB = null;
    public $forumDB = null;
    public $donationsDB = null;
    public $charactersDB2 = null;
    ...
    function __construct()
    {
        ...
        $this->gameDB = new MYSQL_Database(DB_TYPE, DB_HOST_LAN, GAME_DB_NAME, GAME_DB_USER, GAME_DB_PASS);
        ...
        $this->donationsDB = new MYSQL_Database(DB_TYPE, DB_HOST_LAN, DONATIONS_DB_NAME, DONATIONS_DB_USER, DONATIONS_DB_PASS);
        $this->donationsDB->exec("set names utf8");

        $this->charactersDB2 = new MYSQL_Database(DB_TYPE, DB_HOST_LAN_2, CHARACTERS_DB_NAME_2, CHARACTERS_DB_USER_2, CHARACTERS_DB_PASS_2);
        $this->charactersDB2->exec("set names utf8");
